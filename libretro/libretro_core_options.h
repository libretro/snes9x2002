...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      NULL,
      "Many games for the SNES suffered from slowdown due to the weak main CPU. This option helps alleviate that at the cost of possible bugs. Compatible: Reduce slowdown but keep as much game compatibility as much as possible. Max: Reduce slowdown as much as possible but will break more games.",
      NULL,
      NULL,
      {
         { "disabled",   NULL },
